...
var AlertComponent = (function () {
    function AlertComponent() {
        this.alerts = [];
        this._success = new __WEBPACK_IMPORTED_MODULE_1_rxjs_Subject__["a" /* Subject */]();
